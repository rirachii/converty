...
Retain the native app's azure and warm-white icon.
Reference Tangerine for quick workflow explanation, Paste on recent.design for product-led composition, and Amie on recent.design for depth and approachable presentation.
Create original copy, layout, imagery, and motion.
...
Use semantic headings, native disclosure controls, and accessible file-type tabs.
Preserve readable content and navigation when JavaScript is unavailable.
